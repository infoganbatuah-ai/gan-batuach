...
if (hostContinuity && deviceSession) throw new Error("P38_CONNECTOR_RTSP_SESSION_MODE_INVALID");
...
if (rollout.devices !== 2 || rollout.releases !== (deviceSession ? 15 : hostContinuity ? 14 : 10) ||
...
const plan = { protocol: deviceSession ? "observer-push38-connector-device-session-activation-v1" :
