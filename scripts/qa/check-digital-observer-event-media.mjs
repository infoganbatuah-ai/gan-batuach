...
assert.doesNotMatch(alertsPage + runtime + mediaRoute + cloudRoute, /rtsp:\/\/|rtsps:\/\/|password\s*[:=]|credential\s*[:=]/i, "browser and cloud event media code must not expose camera credentials or RTSP URLs");
