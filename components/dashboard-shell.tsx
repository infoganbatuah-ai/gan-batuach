...
const navByRole: Record<UserRole, Array<{ href: string; label: string; hint: string }>> = {
  ...
  inspector: [
    ...
    { href: "/dashboard/inspector/apply", label: "בקשת מפקח", hint: "מועמדות ואישור" },
    ...
    { href: "/dashboard/inspector/observer-pilot", label: "פיילוט תצפיתן", hint: "כיול וסקירה" },
  ...
  manager: [
    ...
    { href: "/dashboard/garden/enrollment-requests", label: "בקשות הורים", hint: "רישום ושיוך" },
    { href: "/dashboard/garden/staff", label: "צוות", hint: "משמרות ואישורים" },
    { href: "/dashboard/garden/staff-applications", label: "מועמדויות צוות", hint: "משרות ואישורים" },
    { href: "/dashboard/garden/cameras", label: "מצלמות", hint: "צפייה ותצפיתן" },
    { href: "/dashboard/garden/observer-pilot", label: "פיילוט תצפיתן", hint: "אירועים לבדיקה" },
  ...
  staff: [
    ...
    { href: "/dashboard/staff/job-market", label: "שוק משרות", hint: "הגשת מועמדות" },
  ...
  parent: [
    ...
    { href: "/dashboard/parent/discover-kindergartens", label: "גילוי גנים", hint: "בקשת הצטרפות" },
