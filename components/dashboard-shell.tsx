...
const navByRole: Record<UserRole, Array<{ href: string; label: string; hint: string }>> = {
  admin: [
    ...
    { href: "/dashboard/admin/camera-deployment", label: "פריסת מצלמות", hint: "Gateway ופיילוט בית" },
    ...
    { href: "/dashboard/admin/vision-ai", label: "זיהוי חזותי", hint: "מודלים וכיול" },
    ...
    { href: "/dashboard/admin/communications", label: "ספקי תקשורת", hint: "WhatsApp, SMS, Email, Push" },
    ...
    { href: "/dashboard/admin/launch-readiness", label: "מוכנות השקה", hint: "Go-live" },
  ...
  manager: [
    ...
    { href: "/dashboard/garden/vision-ai", label: "זיהוי חזותי", hint: "לאחר בדיקה" },
