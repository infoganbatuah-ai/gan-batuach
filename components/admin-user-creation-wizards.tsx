  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const data = await postJson("/api/admin/create-garden-manager", {
        ...
        manager: needsManager ? { full_name: formValue(form, "manager_name"), email: formValue(form, "manager_email") || undefined, phone: formValue(form, "manager_phone"), profile_image_url: managerPhotoUrl } : undefined,
        owner: needsOwner ? { full_name: formValue(form, "owner_name"), email: formValue(form, "owner_email"), phone: formValue(form, "owner_phone"), profile_image_url: ownerPhotoUrl } : undefined
      });
