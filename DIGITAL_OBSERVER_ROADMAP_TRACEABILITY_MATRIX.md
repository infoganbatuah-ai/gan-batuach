...
| Capability family | Canonical owner PUSHES | Final closure boundary |
|---|---|---|
| Camera connection/onboarding/playback | 7, 14–18, 23, 34 | Real authorized customer playback, vendor coverage and health evidence |
| Camera controls and managed edge execution | 14, 18–23, 39 | Capability evidence, policy authorization and real action proof |
| Observer intelligence | 3–13, 28–32, 38, 46–48 | Representative real data, quality metrics and cross-camera proof |
| Decisions, autonomy and escalation | 6, 9–12, 22, 39, 45 | Policy-bounded real action/escalation proof |
| Natural language | 12–13, 39, 42 | Tenant-safe real queries/rules/actions and external API proof |
| Identity and biometrics | 5, 10, 13, 25, 28, 41, 45, 48 | Legal approval plus real quality/consent/tenant evidence |
| Guardian/personal safety | 39, 44–48 | Signed mobile builds, legal approval, real pilot and emergency evidence |
| Enterprise investigation/intelligence | 34, 41–43, 47–50 | External customer/VMS integration and independent-consumer evidence |
| Scale/reliability | 19–23, 31, 35–38, 46–49 | Fault injection, soak, multi-site and 100+ camera proof |
| AI infrastructure/economics/quality | 11, 27–33, 38, 46–49 | Reproducible benchmark, cost and cohort evidence |
| Security/privacy/DD | 18, 24–25, 41–45, 50–52 | Independent security/legal/DD evidence and clean release history |

## COMPLETION RULE

`52/52 PUSHES DONE != PRODUCT COMPLETE` unless every mandatory North-Star row has reached its required final evidence state. A North-Star Completion Audit is required before any `PRODUCT COMPLETE` claim.
...
This appendix preserves the prior 129 reconstructed source slots and their mapping into the same canonical roadmap. Historical status wording is superseded by the current execution queue above; the source-slot ownership remains part of the audit trail.
...
| Original 52 | 39 | [RECONSTRUCTED — SOURCE TEXT UNRESOLVED] Cheap preprocessing | Motion/native events/zones/adaptive sampling | Efficiency | Camera health/data | IMPLEMENTED — NEEDS REAL PROOF | PUSH 29/30 candidate-only preprocessing plus canonical adaptive scheduler and bounded 11-camera workload | Representative recall/latency and native-vendor proof. |
...
| Original 52 | 41 | [RECONSTRUCTED — SOURCE TEXT UNRESOLVED] Portable infrastructure | Containers/cloud/dedicated/NAS; no office dependency | Infrastructure | Shared packages/storage | IMPLEMENTED — NEEDS REAL PROOF | PUSH 34 portable storage plus PUSH 35 clean tracked deployment, portable restore, standard Edge paths and no-office dependency QA | Provider-native DR drill plus PUSH 36–38 horizontal/HA evidence. |
...
| Digital-First 45 | 37 | [RECONSTRUCTED — SOURCE TEXT UNRESOLVED] Local/edge AI | Privacy/cost-aware local inference | AI routing | Portable workers | IMPLEMENTED — NEEDS REAL PROOF | PUSH 32 real Tapo job routed through EDGE_ONLY policy to local ONNX with decision provenance | Representative deployed multi-target workload. |
| Digital-First 45 | 38 | [RECONSTRUCTED — SOURCE TEXT UNRESOLVED] Cloud/dedicated AI | Optional scalable provider inference | AI routing | Provider contracts | FOUNDATION | PUSH 32 shared/dedicated target, provider, region and tenant-policy adapter contract; no provider configured | Authorized real Cloud execution. |
| Digital-First 45 | 39 | [RECONSTRUCTED — SOURCE TEXT UNRESOLVED] Hybrid router | Select edge/local/cloud by policy | AI routing | Multiple providers | IMPLEMENTED — NEEDS REAL PROOF | PUSH 32 hard eligibility, scoring, explanation, no-target and bounded local failover QA | Real Cloud/multi-provider failover with provenance. |
| Digital-First 45 | 40 | [RECONSTRUCTED — SOURCE TEXT UNRESOLVED] Priority/backpressure | Protect streams/tenants under load | Scale | Durable queue | IMPLEMENTED — NEEDS REAL PROOF | PUSH 31 admission/aging/fairness plus PUSH 36 four-process mixed-load and queue-age evidence | Multi-host sustained Production load proof. |
