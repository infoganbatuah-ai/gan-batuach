...
| --- | --- | --- | --- | --- |
| Local live, thumbnails, fullscreen and offline isolation | Gateway + Web | Not accepted / identity recovery in progress | fd226298 production READY; 10/10 local playlists advanced across 11 minutes, but browser renewal timed out and reset players; subsequent device refresh returned 401 while 16/10 mapping remained intact | Prepared Keychain rotation fix dea34d36 deployment, authenticated device approval, repeat sustained buffered-media/fullscreen E2E; local health alone is not acceptance |
