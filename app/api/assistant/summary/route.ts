...
export async function GET() {
  try {
    ...
    if (role === "admin") {
      ...
      return ok({ provider: providerStatus(), role, title: "מה דורש טיפול היום?", summary: "עוזר גן בטוח AI מציג סיכום מבוסס נתונים קיימים. אם ספק AI מחובר, ניתן להחליף בעתיד את מנוע החוקים בקריאה חיצונית מאובטחת.", suggestions: [
    ...
    if (role === "parent") {
      ...
      return ok({ provider: providerStatus(), role, title: "תקציר הילד והגן", summary: "העוזר מסכם יומן יומי, הודעות, מסמכים ודוח פיקוח בשפה פשוטה.", suggestions: [
    ...
    if (role === "staff") {
      ...
      return ok({ provider: providerStatus(), role, title: "תקציר צוות", summary: "העוזר מציג משימות, מסמכים חסרים ודגשים לעבודה היומית.", suggestions: [
    ...
    return ok({ provider: providerStatus(), role, title: "תקציר פקח", summary: "העוזר מסכם גנים משויכים, ביקורות קרובות, איחורים ופערי ציון.", suggestions: [
