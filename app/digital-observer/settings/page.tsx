...
import { Bell, CreditCard, KeyRound, LifeBuoy, LockKeyhole, PhoneOff, ShieldCheck, UserRound } from "lucide-react";
...
export default async function DigitalObserverSettingsPage() {
  ...
  return <ObserverAppShell profile={profile} mode={mode} activeHref="/digital-observer/settings" title="הגדרות ופרופיל" statusLabel="שליטה פרטית"><div className="do-page-stack">
    ...
    {site ? <ObserverRecipientsDevicesForm siteId={site.id} recipients={recipients} devices={devices} /> : null}
    ...
    <section className="do-settings-links"><Link href="/digital-observer/billing"><CreditCard /><span><strong>מנוי וחיוב</strong><small>חבילה, שימוש ובקשות שינוי</small></span></Link><Link href="/digital-observer/readiness"><PhoneOff /><span><strong>ספקים וחירום</strong><small>ניתוב, תבניות, AI Shadow ונוהל הסלמה</small></span></Link><Link href="/digital-observer/people"><UserRound /><span><strong>משתמשים ושיתוף</strong><small>הרשאות, הסכמה ואנשים מוכרים</small></span></Link><Link href="/digital-observer/trust#privacy"><LockKeyhole /><span><strong>פרטיות ושמירה</strong><small>מחיקה, retention ו-AI</small></span></Link><Link href="/digital-observer/trust#support"><LifeBuoy /><span><strong>עזרה ותמיכה</strong><small>ערוץ התמיכה של המוצר</small></span></Link></section>
