...
export default async function DigitalObserverSettingsPage() {
  ...
  return <ObserverAppShell profile={profile} mode={mode} activeHref="/digital-observer/settings" title="מנוי והגדרות" statusLabel="שליטה פרטית"><div className="do-page-stack do-settings-page">
    ...
    <section className="do-settings-editor-grid" id="personal">
      ...
      <div className="do-settings-monitoring-card" id="monitoring">{site ? <ObserverSettingsForm siteId={site.id} schedule={schedule} channels={channels} /> : <div className="do-empty"><ShieldCheck /><strong>יש להקים אתר לפני הגדרת ניטור</strong><Link className="do-button primary" href="/digital-observer/onboarding">הקמת אתר</Link></div>}</div>
    </section>
