        ...
        {!selectedSite ? (
          ...
          <>
            ...
            <section className="do-live-intelligence business">
              <div className="do-live-intelligence-summary">
                <div className="do-section-head"><div><span className="do-badge info"><Sparkles /> תמונת מצב חכמה</span><h2>מה השתנה בעסק</h2><p>תנועה, כניסה ויציאה, רכב, חריגות ומצלמות לפי נתוני האתר.</p></div><Link className="do-link" href="/digital-observer/rules">שיחה מלאה</Link></div>
