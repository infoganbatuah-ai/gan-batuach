  ...
  return (
    ...
    >
      <div className="do-page-stack do-people-screen">
        ...
        {site && !childPrivacy && peopleTab ? <details className="do-panel do-people-add-disclosure" id="add-known-person"><summary>הוספת אדם מוכר באופן ידני</summary><p>אפשר להוסיף אדם לאחר הסכמה. הצעות אוטומטיות יגיעו רק ממנוע Shadow מחובר ומאושר.</p><ObserverKnownPersonForm siteId={site.id} /></details> : null}
