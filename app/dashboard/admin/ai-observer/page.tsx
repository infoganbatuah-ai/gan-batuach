import { AlertTriangle, Bot, Camera, MessageSquareWarning, UserRoundSearch } from "lucide-react";
import { AiEventActions } from "@/components/ai-event-actions";
...
export default async function AiObserverDashboardPage() {
  ...
  return (
    <DashboardShell role="admin" title="תצפיתן AI">
      <div className="dashboard-hero-card ai-hero-card"><div><p className="eyebrow">Digital Safety Assistant</p><h1>תצפיתן AI שמתרגם אירועים למשימות טיפול.</h1><p>המודול עובד עם confidence, threshold, cooldown, snapshot, timeline, alerts ויצירת משימה במקרה קריטי.</p></div><span className="pill bad"><Bot size={15} /> Gateway חסר</span></div>
