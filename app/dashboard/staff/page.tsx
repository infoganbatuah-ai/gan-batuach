...
export default async function StaffDashboard() {
  ...
  const staffRole = staff?.role ?? (profile as any).role_title ?? "צוות גן";
  const staffCommandItems = [
    ...
    { title: "דיווח אירוע", count: "מהיר", description: "אם קרה משהו חריג, מתעדים מיד", href: "/dashboard/staff/incidents", tone: "good" as const, icon: AlertTriangle },
