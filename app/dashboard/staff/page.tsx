...
export default async function StaffDashboard() {
  ...
  return (
    <DashboardShell role="staff" title="ממשק צוות">
      ...
      <div className="grid cols-3 dashboard-kpis"><StatCard label="סטטוס עבודה" value="דורש אימות" tone="warn" /><StatCard label="שעות החודש" value="מעקב" /><StatCard label="משימות" value="פתוחות" /></div>
