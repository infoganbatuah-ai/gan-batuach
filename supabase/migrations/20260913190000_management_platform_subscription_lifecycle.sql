...
begin
  if not public.is_admin() and not public.can_manage_garden(target_garden_id) then
...
begin
  if not public.can_manage_garden(target_garden_id) then raise exception 'garden_forbidden' using errcode='42501'; end if;
