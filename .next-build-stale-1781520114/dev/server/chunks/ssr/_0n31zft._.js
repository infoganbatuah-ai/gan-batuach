...
"[project]/app/dashboard/admin/pilot-center/actions.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"40cf545a96b5b316938df6652978896449ec7be0ec":{"name":"updatePilotParticipant"},"40eeb0ef225ef6ea1c71561b0f041dd1e865a71d5f":{"name":"updatePilotProgram"}},"app/dashboard/admin/pilot-center/actions.ts",""] */ __turbopack_context__.s([
...
function revalidatePilotPaths() {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])("/dashboard/admin/pilot-center");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])("/dashboard/admin/launch-readiness");
}
async function updatePilotProgram(formData) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["requireRole"])([
        "admin"
    ]);
    const id = text(formData, "id");
    const pilotStatus = requireAllowed(text(formData, "pilot_status"), [
        "planned",
        "inviting",
        "active",
        "paused",
    ...
    const onboardingStatus = requireAllowed(text(formData, "onboarding_status"), [
        "not_started",
        "invited",
        "in_progress",
        "completed",
    ...
    const observerStatus = requireAllowed(text(formData, "observer_status"), [
        "not_started",
        "configured",
        "shadow_active",
        "review_active",
    ...
    const now = new Date().toISOString();
    const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
    const { error } = await supabase.from("pilot_programs").update({
...
async function updatePilotParticipant(formData) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["requireRole"])([
        "admin"
    ]);
    const id = text(formData, "id");
    const participantStatus = requireAllowed(text(formData, "participant_status"), [
        "invited",
        "active",
        "completed",
        "suspended"
    ...
    const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
    const { error } = await supabase.from("pilot_participants").update(updates).eq("id", id);
    if (error) throw new Error(error.message);
    revalidatePilotPaths();
}
;
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(updatePilotProgram, "40eeb0ef225ef6ea1c71561b0f041dd1e865a71d5f", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(updatePilotParticipant, "40cf545a96b5b316938df6652978896449ec7be0ec", null);
}),
"[project]/.next-internal/server/app/dashboard/admin/pilot-center/page/actions.js { ACTIONS_MODULE0 => \"[project]/app/dashboard/admin/launch-readiness/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/app/dashboard/admin/pilot-center/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dashboard$2f$admin$2f$pilot$2d$center$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/dashboard/admin/pilot-center/actions.ts [app-rsc] (ecmascript)");
;
;
;
;
...
"[project]/.next-internal/server/app/dashboard/admin/pilot-center/page/actions.js { ACTIONS_MODULE0 => \"[project]/app/dashboard/admin/launch-readiness/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/app/dashboard/admin/pilot-center/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "40cf545a96b5b316938df6652978896449ec7be0ec",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dashboard$2f$admin$2f$pilot$2d$center$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updatePilotParticipant"],
    ...
    "40eeb0ef225ef6ea1c71561b0f041dd1e865a71d5f",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dashboard$2f$admin$2f$pilot$2d$center$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updatePilotProgram"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$dashboard$2f$admin$2f$pilot$2d$center$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$app$2f$dashboard$2f$admin$2f$launch$2d$readiness$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$app$2f$dashboard$2f$admin$2f$pilot$2d$center$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/dashboard/admin/pilot-center/page/actions.js { ACTIONS_MODULE0 => "[project]/app/dashboard/admin/launch-readiness/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/app/dashboard/admin/pilot-center/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dashboard$2f$admin$2f$launch$2d$readiness$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/dashboard/admin/launch-readiness/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dashboard$2f$admin$2f$pilot$2d$center$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/dashboard/admin/pilot-center/actions.ts [app-rsc] (ecmascript)");
}),
];

//# sourceMappingURL=_0n31zft._.js.map