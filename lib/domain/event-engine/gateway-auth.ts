...
// The fingerprint intentionally exposes neither a URL nor a credential. It is
// returned only on the already-authenticated Gateway manifest so an operator
// can compare the Gateway's canonical backend with its configured environment.
