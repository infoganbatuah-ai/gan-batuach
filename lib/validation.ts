...
export const cameraStreamSchema = z.object({
  ...
  connection_host: z.string().optional(),
  connection_port: z.coerce.number().int().optional(),
  connection_channel: z.coerce.number().int().optional(),
  stream_quality: z.enum(["main", "sub"]).optional(),
  deployment_scope: z.string().optional(),
  test_site_type: z.enum(["home_test", "business_test", "kindergarten_test"]).optional(),
  camera_provider_key: z.string().optional(),
  gateway_provider_preference: z.enum(["mediamtx", "go2rtc", "custom"]).optional(),
  live_preview_status: z.string().optional(),
  clip_readiness_status: z.string().optional(),
  snapshot_readiness_status: z.string().optional(),
  permission_model: z.string().optional(),
  username: z.string().optional(),
  password: z.string().optional(),
  manual_rtsp_url: z.string().optional(),
  rtsp_template: z.string().optional(),
  last_test_status: z.string().optional(),
  last_test_message: z.string().optional(),
  gateway_registration_status: z.string().optional(),
  gateway_last_error: z.string().optional(),
  masked_connection_summary: z.record(z.string(), z.unknown()).optional(),
